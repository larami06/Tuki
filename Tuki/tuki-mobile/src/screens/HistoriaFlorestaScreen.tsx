...
const PAGINAS = [
  {
    emoji: '🌲', bg: '#DCFCE7', textoBg: '#BBF7D0',
    titulo: 'A Grande Floresta',
    texto: 'Era uma vez um coelhinho chamado Nino que adorava explorar. Toda manhã ele saía de sua toca com o coração cheio de alegria!',
  },
  {
    emoji: '🌸', bg: '#FDF4FF', textoBg: '#F3E8FF',
    titulo: 'O Caminho Mágico',
    texto: 'Um dia, Nino encontrou um caminho misterioso cheio de flores coloridas e borboletas dançando no ar. Que lindo!',
  },
  {
    emoji: '🐦', bg: '#EFF6FF', textoBg: '#DBEAFE',
    titulo: 'Um Novo Amigo',
    texto: 'De repente, Nino ouviu um barulhinho triste. Era um passarinho amarelo preso num galho alto, com a asinha enrolada.',
  },
  {
    emoji: '🤝', bg: '#FFFBEB', textoBg: '#FEF3C7',
    titulo: 'A Ajuda',
    texto: 'Com muito cuidado e carinho, Nino subiu devagar e libertou o passarinho. O bichinho cantou de felicidade!',
  },
  {
    emoji: '⭐', bg: '#FFF1F2', textoBg: '#FFE4E6',
    titulo: 'A Lição',
    texto: 'Nino aprendeu que ajudar os outros é a maior aventura de todas. Eles viraram amigos para sempre! Fim. 💕',
  },
];

const QUIZ = {
  pergunta: 'O que o coelhinho Nino fez para ajudar o passarinho? 🐦',
  opcoes: [
    'Subiu devagar no galho e o libertou',
    'Chamou um pássaro grande para ajudar',
  ],
  correta: 0,
};
...
export default function HistoriaFlorestaScreen() {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: fase === 'lendo' ? pagina.bg : '#FAFAFA' }]}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Aventuras na Floresta</Text>
...
const styles = StyleSheet.create({
  ...
  dotAtivo: { backgroundColor: '#6D28D9', width: 28 },
  ...
  texto: { fontSize: 18, color: '#374151', lineHeight: 28, textAlign: 'center', fontWeight: '500' },
  nav: {
  ...
  navBtnAvancar: { backgroundColor: '#7C3AED', elevation: 4 },
  ...
  // Quiz / Resultado / Recompensa (compartilhado)
  quizContainer: {
  ...
  opcaoBtnA: { backgroundColor: '#EDE9FE' },
  ...
  recompensaParcialText: { fontSize: 13, fontWeight: '700', color: '#92400E' },
  resultadoBtn: {
