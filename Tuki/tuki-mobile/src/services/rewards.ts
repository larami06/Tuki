// ─── Tipos ────────────────────────────────────────────────────────────────────
export type ItemType = 'moedas' | 'estrelas' | 'xp' | 'diamantes' | 'nada';
...
// ─── Fatias da roleta ─────────────────────────────────────────────────────────
// Diamantes são raros: apenas 1 fatia de 8. "Nada" é o risco divertido.
...
const GAME_REWARDS: Record<number, RewardConfig> = {
  ...
  7: { baseXP: 50, baseMoedas: 45, baseEstrelas: 15, perfeito: { diamantes: 1 } },       // Desafio Final Alfa
  ...
  26: { baseXP: 40, baseMoedas: 35, baseEstrelas: 12, perfeito: { diamantes: 1 } },
  ...
  35: { baseXP: 38, baseMoedas: 32, baseEstrelas: 11, perfeito: { diamantes: 1 } },       // Lógica Alienígena
  36: { baseXP: 55, baseMoedas: 50, baseEstrelas: 18, perfeito: { diamantes: 2 } },       // Mestre da Galáxia
};
...
export function calcularRecompensa(idLicao: number, acertos: number, total: number): GameReward {
  ...
  return {
    ...
    diamantes: perfeito && config.perfeito ? config.perfeito.diamantes : 0,
    perfeito,
  };
}
